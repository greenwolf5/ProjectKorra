...
public abstract class FireAbility extends ElementalAbility {
	...
	//method to play beehive buzz when charging lightning. Not sure if should be here, or moved.
	...
	//Hit sound for when lightning strikes, not sure if moved into FireAbility or kept here.
